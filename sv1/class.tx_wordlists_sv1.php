...
class tx_wordlists_sv1 extends t3lib_svbase {
				var $prefixId = 'tx_wordlists_sv1';		// Same as class name
				var $scriptRelPath = 'sv1/class.tx_wordlists_sv1.php';	// Path to this script relative to the extension dir.
				var $extKey = 'wordlists';	// The extension key.
